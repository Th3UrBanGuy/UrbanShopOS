      ...
      {subTab === 'system' && (
        <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
          ...
          <div className="xl:col-span-3 space-y-3">
            ...
            {/* Report Branding */}
            <SectionAccordion icon={FileText} title="Report Branding" accent="#10b981">
              <p className="text-[10px] font-bold text-white/30 uppercase tracking-widest mb-3">Customization for Ledgers & Lists</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
