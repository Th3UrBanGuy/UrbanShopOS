...
const MANAGEMENT_TOOLS: {
...
}[] = [
  {
    id: 'Inventory',
    title: 'Stock Room',
    description: 'Real-time inventory control & product configuration.',
  ...
  },
  {
    id: 'Parties',
    title: 'Partner List',
    description: 'Supplier ledgers, owner accounts & payment history.',
    icon: <Users size={32} />,
    color: '#3B82F6', 
  ...
  },
  {
    id: 'Coupons',
    title: 'Offers & Promo',
    description: 'Generate discount codes & loyalty campaigns.',
    icon: <Ticket size={32} />,
    color: '#F43F5E', 
  ...
  },
  {
    id: 'Users',
    title: 'Staff Hub',
    description: 'Employee access control, POS pins & permissions.',
  ...
  },
  {
    id: 'Settings',
    title: 'App Settings',
    description: 'Global business profile, system & bill configuration.',
